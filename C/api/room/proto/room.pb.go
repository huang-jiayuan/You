...
const file_room_proto_rawDesc = "" +
	...
	"\vtotal_pages\x18\x05 \x01(\x05R\n" +
	"totalPages\x12\x18\n" +
	"\akeyword\x18\x06 \x01(\tR\akeyword2\x97\x03\n" +
	"\x04Room\x12*\n" +
	"\x05greet\x12\x0f.room.StreamReq\x1a\x10.room.StreamResp\x12C\n" +
	"\n" +
...
var file_room_proto_depIdxs = []int32{
	...
	4,  // 4: room.Room.UpdateRoom:input_type -> room.UpdateRoomStreamReq
	2,  // 5: room.Room.CreateRoom:input_type -> room.CreateRoomStreamReq
	7,  // 6: room.Room.GetRecommendRooms:input_type -> room.GetRecommendRoomsReq
	9,  // 7: room.Room.GetRoomsByCategory:input_type -> room.GetRoomsByCategoryReq
	11, // 8: room.Room.SearchRooms:input_type -> room.SearchRoomsReq
	1,  // 9: room.Room.greet:output_type -> room.StreamResp
	5,  // 10: room.Room.UpdateRoom:output_type -> room.UpdateRoomStreamResp
	3,  // 11: room.Room.CreateRoom:output_type -> room.CreateRoomStreamResp
	8,  // 12: room.Room.GetRecommendRooms:output_type -> room.GetRecommendRoomsResp
	10, // 13: room.Room.GetRoomsByCategory:output_type -> room.GetRoomsByCategoryResp
	12, // 14: room.Room.SearchRooms:output_type -> room.SearchRoomsResp
