...
type Mute struct {
  ...
  OperatorId  *int `json:"operatorId" form:"operatorId" gorm:"comment:操作人ID;column:operator_id;" binding:"required"`  //操作人ID
  ...
  MuteResult  *string `json:"muteResult" form:"muteResult" gorm:"comment:处理结果;column:mute_result;size:50;" binding:"required"`  //处理结果
